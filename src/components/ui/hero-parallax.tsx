  ...
  return (
    <div className="max-w-7xl relative mx-auto py-10 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold text-black dark:text-white">
        Vote For Them <br /> Make You Win
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-gray-500">
        Powering Fair, Fun, and Transparent Voting for Every Competition. Cast
